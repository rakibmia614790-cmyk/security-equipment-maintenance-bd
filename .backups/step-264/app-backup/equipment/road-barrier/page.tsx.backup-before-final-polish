    ...
    <main className="min-h-screen bg-[#06111f] text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
            Professional vehicle access control and automatic barrier
            solutions for airports, government facilities, commercial sites,
            parking areas and critical infrastructure.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Controlled Vehicle Access</h2>
          </div>
          <p className="text-lg leading-8 text-slate-300">
            Automatic road barriers provide controlled vehicle entry and exit
            while integrating with access control, parking management,
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ["Automatic Operation", "Fast and controlled vehicle movement."],
            ["Access Integration", "Integration with modern access systems."],
            ["Traffic Control", "Reliable management of vehicle entry and exit."],
            ["Technical Support", "Installation, maintenance and repair services."],
          ].map(([title, text]) => (
      ...
      <section className="border-y border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          ...
          <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Vehicle Security Applications</h2>
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              "Residential & Controlled Communities",
            ].map((item) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        ...
        <h2 className="mt-3 max-w-3xl text-3xl font-bold sm:text-4xl">Barrier & Vehicle Access Technology</h2>
        <p className="mt-5 max-w-3xl leading-7 text-slate-400">
          Our technical coverage is structured around a broad ecosystem of
          automatic barrier and vehicle access control technologies.
        </p>
      ...
      <section className="mx-auto max-w-5xl px-6 py-24 text-center lg:px-8">
        ...
        <h2 className="mt-4 text-3xl font-bold sm:text-4xl">Need Road Barrier Support?</h2>
        <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-400">
          Contact our technical team for installation, maintenance,
          troubleshooting, repair and access-control integration support.
        </p>
