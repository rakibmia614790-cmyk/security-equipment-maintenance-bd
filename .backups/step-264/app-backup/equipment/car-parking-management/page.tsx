    ...
    <main className="min-h-screen bg-[#06111f] text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-sky-400">
            Smart Mobility & Vehicle Management
          </p>
          <h1 className="max-w-4xl text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
            Car Parking Management System
          </h1>
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
            Intelligent parking management solutions for airports, commercial
            facilities, government sites, hospitals, campuses and large-scale
            vehicle-access environments.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Intelligent Parking Operations</h2>
          </div>
          <p className="text-lg leading-8 text-slate-300">
            Modern parking management combines vehicle identification,
            barriers, ticketing or credential systems, payment, occupancy
            monitoring and centralized management to streamline parking
            operations.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ["Vehicle Access", "Automated entry and exit management."],
            ["License Plate Recognition", "Vehicle identification and monitoring."],
            ["Parking Guidance", "Improved visibility of parking availability."],
            ["Central Management", "Integrated monitoring and operational control."],
          ].map(([title, text]) => (
      ...
      <section className="border-y border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          ...
          <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Parking & Vehicle Management Applications</h2>
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              "Corporate & Residential Complexes",
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        ...
        <h2 className="mt-3 max-w-3xl text-3xl font-bold sm:text-4xl">Parking Management Technology</h2>
        <p className="mt-5 max-w-3xl leading-7 text-slate-400">
          Our technical coverage is structured around a broad ecosystem of
          parking management, vehicle access and smart mobility technologies.
        </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              "Corrective Repair",
              "Barrier & Controller Diagnostics",
              "LPR & Camera System Support",
      ...
      <section className="mx-auto max-w-5xl px-6 py-24 text-center lg:px-8">
        ...
        <h2 className="mt-4 text-3xl font-bold sm:text-4xl">Need Parking System Support?</h2>
        <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-400">
          Contact our technical team for installation, maintenance,
          troubleshooting, repair and parking-system integration support.
        </p>
