    ...
    <main className="min-h-screen bg-[#06111f] text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-sky-400">
            Perimeter & Vehicle Security
          </p>
          <h1 className="max-w-4xl text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
            Security Bollard System
          </h1>
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
            Professional fixed, removable and automatic bollard solutions for
            perimeter protection, vehicle access control and high-security
            facilities.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Perimeter Protection & Vehicle Control</h2>
          </div>
          <p className="text-lg leading-8 text-slate-300">
            Security bollards provide controlled vehicle access and perimeter
            protection while supporting integration with access control,
            traffic management and other security systems.
          </p>
        </div>

        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ["Automatic Bollards", "Controlled rising and lowering operation."],
            ["Fixed Bollards", "Permanent perimeter and access protection."],
            ["Removable Bollards", "Flexible access management where required."],
            ["System Integration", "Integration with modern security systems."],
          ].map(([title, text]) => (
      ...
      <section className="border-y border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          ...
          <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Perimeter Security Applications</h2>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        ...
        <h2 className="mt-3 max-w-3xl text-3xl font-bold sm:text-4xl">Bollard & Perimeter Security Technology</h2>
        <p className="mt-5 max-w-3xl leading-7 text-slate-400">
          Our technical coverage is structured around a broad ecosystem of
          bollard, perimeter protection and vehicle access technologies.
        </p>
      ...
      <section className="mx-auto max-w-5xl px-6 py-24 text-center lg:px-8">
        ...
        <h2 className="mt-4 text-3xl font-bold sm:text-4xl">Need Bollard System Support?</h2>
        <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-400">
          Contact our technical team for installation, maintenance,
          troubleshooting, repair and perimeter-security integration support.
        </p>
