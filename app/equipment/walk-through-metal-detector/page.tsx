...
const manufacturers = [
  { name: "CEIA", logo: "/branding/wtmd-brands/ceia.svg" },
  { name: "Garrett", logo: "/branding/wtmd-brands/garrett.svg" },
  { name: "Rapiscan Systems", logo: "/branding/wtmd-brands/rapiscan.svg" },
  { name: "Smiths Detection", logo: "/branding/wtmd-brands/smiths-detection.svg" },
  { name: "Nuctech", logo: "/branding/wtmd-brands/nuctech.svg" },
];
